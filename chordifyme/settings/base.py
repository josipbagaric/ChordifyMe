"""
Django settings for chordifyme project.
...
WSGI_APPLICATION = 'chordifyme.wsgi.application'
...
EMAIL_HOST_USER = 'joseph@josephit.com'
EMAIL_HOST_PASSWORD = os.environ['EMAIL_HOST_PASSWORD']
EMAIL_PORT = 587
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
DEFAULT_FROM_EMAIL = 'joseph@josephit.com'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'chordifyme_file': {
            ...
            'backupCount': 10,
            'filename': os.path.join(BASE_DIR, logging_folder_name + 'chordifyme.log'),
            'formatter': 'verbose'
        },
    },
    'loggers': {
        ...
        'chordifyme_console': {
            'level': 'DEBUG',
            'handlers': ['console', 'chordifyme_file'],
            'propagate': False,
        },
    },
}
...
DBBACKUP_BACKUP_DIRECTORY = os.path.join(BASE_DIR, 'chordifyme_management/backups/')
...
ADMINS = [('Joseph', 'joseph@josephit.com')]